...
constexpr void CircleEq<T>::compute(T x1, T y1, T x2, T y2, T x3, T y3) {
  bool noflip = ::hipsycl::sycl::detail::__hipsycl_abs(x3 - x1) < ::hipsycl::sycl::detail::__hipsycl_abs(y3 - y1);
