#ifndef SYCLDataFormatsTrackTrackHeterogeneous_H
#define SYCLDataFormatsTrackTrackHeterogeneous_H

#include "SYCLDataFormats/TrajectoryStateSoA.h"
...
#endif  // SYCLDataFormatsTrackTrackSoA_H
