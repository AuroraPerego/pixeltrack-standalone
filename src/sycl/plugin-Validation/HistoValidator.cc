...
private:
  ...
  edm::EDGetTokenT<cms::sycltools::Product<SiPixelDigisSYCL>> digiToken_;
  edm::EDGetTokenT<cms::sycltools::Product<SiPixelClustersSYCL>> clusterToken_;
  edm::EDGetTokenT<cms::sycltools::Product<TrackingRecHit2DSYCL>> hitToken_;
