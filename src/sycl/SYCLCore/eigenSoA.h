#ifndef HeterogeneousCore_SYCLUtilities_interface_eigenSoA_h
#define HeterogeneousCore_SYCLUtilities_interface_eigenSoA_h
...
#endif  // HeterogeneousCore_SYCLUtilities_interface_eigenSoA_h
