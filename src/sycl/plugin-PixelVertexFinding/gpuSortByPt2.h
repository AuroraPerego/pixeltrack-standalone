...
namespace gpuVertexFinder {
  ...
  inline void sortByPt2(ZVertices* pdata, WorkSpace* pws, sycl::nd_item<1> item, uint16_t* sws, int32_t *c, int32_t *ct, int32_t *cu, int *ibs, int *p, uint32_t * firstNeg) {
    ...
    inline void sortByPt2CPU(ZVertices* pdata, WorkSpace* pws, sycl::nd_item<1> item) {
    auto& __restrict__ data = *pdata;
    auto& __restrict__ ws = *pws;
    auto nt = ws.ntrks;
    float const* __restrict__ ptt2 = ws.ptt2;
  ...
  void sortByPt2Kernel(ZVertices* pdata, WorkSpace* pws, sycl::nd_item<1> item, uint16_t* sws, int32_t *c, int32_t *ct, int32_t *cu, int *ibs, int *p, uint32_t * firstNeg) { sortByPt2(pdata, pws, item, sws, c, ct, cu, ibs, p, firstNeg); }
